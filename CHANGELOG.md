...
- Add support for Engine settings [(#854)](https://github.com/wazuh/wazuh-indexer-plugins/pull/854)
...
- Add performance testing tooling: real-world AIO+agents (Track A), indexer-only OpenSearch Benchmark (Track B), and cold-start + continuous node_exporter/Prometheus monitoring (Track C), with host+indexer metrics sampler and hardware-utilization report
...
- Fix duplicated policies on multi-node environment [(#847)](https://github.com/wazuh/wazuh-indexer-plugins/pull/847)
