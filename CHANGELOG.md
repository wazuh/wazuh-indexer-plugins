...
- Reduce snapshot ingestion overhead with partial JSON parsing [(#1387)](https://github.com/wazuh/wazuh-indexer-plugins/pull/1387)
...
- Update to JDK 25 [(#882)](https://github.com/wazuh/wazuh-indexer-plugins/pull/882)
