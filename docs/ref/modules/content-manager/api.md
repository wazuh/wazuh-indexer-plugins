...
| `detector` | Object  | No       | Integration detector (see below)                                                     |
...
Fields within `resource.detector`:

| Field           | Type    | Required | Description                                                              |
| --------------- | ------- | -------- | ------------------------------------------------------------------------ |
| `enabled`       | Boolean | No       | Whether the detector is active (default: true).                          |
| `interval`      | Integer | No       | No	Scan interval in minutes (default: 2).                                |
| `source`        | Array   | No       | List of index patterns to monitor (default: wazuh-events-v5-{category}). |
  ...
  -d '{
    "resource": {
      ...
      "detector": {
        "enabled": true,
        "interval": 5,
        "source": ["wazuh-events-v5-cloud-services*"]
      },
