...
Modifying these files directly is not recommended. Instead, use the Wazuh Dashboard Security plugin to create new security resources. See [Defining users and roles](defining-users-and-roles.md).
