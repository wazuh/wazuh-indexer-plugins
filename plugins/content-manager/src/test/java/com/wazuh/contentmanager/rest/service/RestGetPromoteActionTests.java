...
public class RestGetPromoteActionTests extends OpenSearchTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        this.action = new RestGetPromoteAction();
    }
    ...
    public void testRoutePath() {
        Assert.assertEquals(PluginSettings.PROMOTE_URI, this.action.routes().get(0).getPath());
    }

    public void testName() {
        Assert.assertEquals("content_manager_promote_preview", this.action.getName());
    }
}
