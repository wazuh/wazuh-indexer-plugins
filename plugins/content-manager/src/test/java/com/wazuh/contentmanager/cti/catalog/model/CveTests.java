...
public class CveTests extends OpenSearchTestCase {
    ...
    public void testCveWithCveType() {
    ...
    public void testCveWithTidType() {
    ...
    public void testCveWithCnaMappingGlobalType() {
    ...
    public void testCveWithFeedGlobalType() {
    ...
    public void testCveWithOscpeGlobalType() {
    ...
    public void testCveWithTcpeType() {
    ...
    public void testCveWithTvendorsType() {
    ...
    public void testCveSerializationIncludesAllFields() {
        ObjectNode payload = this.mapper.createObjectNode();
    ...
    public void testCveWithoutType() {
        ObjectNode payload = this.mapper.createObjectNode();
    ...
    public void testCveWithCaseVariations() {
        // Test lowercase
        Cve cve1 = Cve.fromPayload(this.mapper.createObjectNode(), "cve-2026-0001");
        JsonNode serialized1 = this.mapper.valueToTree(cve1);
        assertEquals(
                "Lowercase CVE pattern should map to CVE type", "CVE", serialized1.get("type").asText());

        // Test uppercase
        Cve cve2 = Cve.fromPayload(this.mapper.createObjectNode(), "CVE-2026-0002");
        JsonNode serialized2 = this.mapper.valueToTree(cve2);
        assertEquals(
                "Uppercase CVE pattern should map to CVE type", "CVE", serialized2.get("type").asText());

        // Test mixed case
        Cve cve3 = Cve.fromPayload(this.mapper.createObjectNode(), "Cve-2026-0003");
        JsonNode serialized3 = this.mapper.valueToTree(cve3);
        assertEquals(
    ...
    public void testCveAllTypes() {
        ...
        for (int i = 0; i < resources.length; i++) {
            Cve cve = Cve.fromPayload(this.mapper.createObjectNode(), resources[i]);
            JsonNode serialized = this.mapper.valueToTree(cve);
            assertEquals(
                    "Type for resource " + resources[i], expectedTypes[i], serialized.get("type").asText());
        }
    ...
    public void testCveExplicitTypeOverridesDerived() {
        ObjectNode payload = this.mapper.createObjectNode();
