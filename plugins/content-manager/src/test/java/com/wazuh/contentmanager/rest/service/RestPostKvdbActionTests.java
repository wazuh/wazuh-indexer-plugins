...
public class RestPostKvdbActionTests extends OpenSearchTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        this.action = new RestPostKvdbAction();
    }
    ...
    public void testRoutePath() {
        Assert.assertEquals(PluginSettings.KVDBS_URI, this.action.routes().get(0).getPath());
    }

    public void testName() {
        Assert.assertEquals("content_manager_kvdb_create", this.action.getName());
    }
}
