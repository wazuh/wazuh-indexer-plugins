...
public class RestPostLogtestActionTests extends OpenSearchTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        this.action = new RestPostLogtestAction();
    }
    ...
    public void testRoutePath() {
        Assert.assertEquals(PluginSettings.LOGTEST_URI, this.action.routes().get(0).getPath());
    }

    public void testName() {
        Assert.assertEquals("content_manager_logtest", this.action.getName());
    }
}
