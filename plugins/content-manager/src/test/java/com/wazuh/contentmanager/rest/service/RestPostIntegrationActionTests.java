...
public class RestPostIntegrationActionTests extends OpenSearchTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        this.action = new RestPostIntegrationAction();
    }
    ...
    public void testRoutePath() {
        Assert.assertEquals(PluginSettings.INTEGRATIONS_URI, this.action.routes().get(0).getPath());
    }

    public void testName() {
        Assert.assertEquals("content_manager_integration_create", this.action.getName());
    }
}
