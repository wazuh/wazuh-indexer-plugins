...
public class RestPostFilterActionTests extends OpenSearchTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        this.action = new RestPostFilterAction();
    }
    ...
    public void testRoutePath() {
        Assert.assertEquals(PluginSettings.FILTERS_URI, this.action.routes().get(0).getPath());
    }

    public void testName() {
        Assert.assertEquals("content_manager_filter_create", this.action.getName());
    }
}
