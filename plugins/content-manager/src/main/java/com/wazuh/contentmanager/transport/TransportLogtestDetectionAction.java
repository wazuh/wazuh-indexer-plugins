...
public class TransportLogtestDetectionAction
        extends HandledTransportAction<LogtestDetectionRequest, LogtestResponse> {
    ...
    protected void doExecute(
        ...
        try {
            ...
            // 2. Validate required fields: space, integration, input
