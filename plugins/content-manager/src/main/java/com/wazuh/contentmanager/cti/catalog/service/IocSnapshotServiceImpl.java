 ...
 */
public class IocSnapshotServiceImpl implements SnapshotService {
    private static final Logger log = LogManager.getLogger(IocSnapshotServiceImpl.class);
        ...
        try (BufferedReader reader = Files.newBufferedReader(filePath, StandardCharsets.UTF_8)) {
            while ((line = reader.readLine()) != null) {
                try {
                    ...
                    ContentIndex indexHandler = this.indicesMap.get(Constants.KEY_IOCS);
