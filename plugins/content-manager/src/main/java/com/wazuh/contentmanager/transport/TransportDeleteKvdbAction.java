...
/** Transport action for deleting KVDB resources. */
public class TransportDeleteKvdbAction extends AbstractTransportDeleteAction {

    @Inject
    public TransportDeleteKvdbAction(
            TransportService transportService,
            ActionFilters actionFilters,
            Client client,
            EngineService engine) {
        super(DeleteKvdbAction.NAME, transportService, actionFilters, client, engine);
    }
