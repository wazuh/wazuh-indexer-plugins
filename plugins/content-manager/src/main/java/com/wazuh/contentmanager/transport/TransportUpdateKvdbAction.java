...
/** Transport action for updating KVDB resources. */
public class TransportUpdateKvdbAction extends AbstractTransportUpdateAction {

    @Inject
    public TransportUpdateKvdbAction(
            TransportService transportService,
            ActionFilters actionFilters,
            Client client,
            EngineService engine) {
        super(UpdateKvdbAction.NAME, transportService, actionFilters, client, engine);
    }
