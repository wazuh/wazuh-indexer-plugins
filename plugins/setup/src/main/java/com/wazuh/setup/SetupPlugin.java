...
public class SetupPlugin extends Plugin implements ClusterPlugin {
    ...
    public Collection<Object> createComponents(
        ...
        // Stream indices
        this.indices.add(
                new StreamIndex("wazuh-alerts-5.x-0001", "index-template-alerts", "wazuh-alerts"));
        this.indices.add(
                new StreamIndex("wazuh-archives-5.x-0001", "index-template-archives", "wazuh-archives"));
        // State indices
        ...
        this.indices.add(new StateIndex("wazuh-states-fim-files", "index-template-fim-files"));
        this.indices.add(
                new StateIndex("wazuh-states-fim-registries", "index-template-fim-registries"));
        ...
        this.indices.add(
                new StateIndex("wazuh-states-inventory-interfaces", "index-template-interfaces"));
        ...
        this.indices.add(
                new StateIndex("wazuh-states-inventory-processes", "index-template-processes"));
        this.indices.add(
                new StateIndex("wazuh-states-inventory-protocols", "index-template-protocols"));
        this.indices.add(new StateIndex("wazuh-states-inventory-system", "index-template-system"));
        this.indices.add(
                new StateIndex("wazuh-states-vulnerabilities", "index-template-vulnerabilities"));
