...
def generate_random_process():
    process = {
        ...
        'group': {
            'id': f'groupid{random.randint(0, 9999)}'
        },
        ...
        'pid': random.randint(1, 9999),
        'real_group': {
            'id': f'realgroupid{random.randint(0, 9999)}'
        },
        'real_user': {
            'id': f'realuserid{random.randint(0, 9999)}'
        },
        'saved_group': {
            'id': f'savedgroupid{random.randint(0, 9999)}'
        },
        'saved_user': {
            'id': f'saveduserid{random.randint(0, 9999)}'
        },
